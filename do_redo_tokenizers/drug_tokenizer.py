...
if __name__ == "__main__":
    ...
    t = DrugTokenizer(size=40000,name="drug")
    with open(join(dirname(abspath(__file__)), "vocab-build-data/drug-text.txt"), "r") as fp:
        text = fp.read()

    t.build(text, exceptions=['O', 'B-drug', 'I-drug'])
