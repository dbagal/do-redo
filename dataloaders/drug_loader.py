...
from do_redo_tokenizers.drug_tokenizer import DrugTokenizer
...
if __name__ == "__main__":
    ...
    tokenizer = DrugTokenizer(size=10000)
    
    data_file = "datasets/drug/train.data"

    d = DrugDataset(tokenizer, data_file)
    print(d.x.shape, d.y.shape)
    
    y1 = torch.sum(d.y.view(-1,3), dim=0)
    print(y1.tolist())
